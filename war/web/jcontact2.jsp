			...
			<div class="modal-dialog modal-sm"  >
			    <div class="modal-content" >
			      ...
			      <div class="modal-footer">
			        ...
			        <button type="button" class="btn btn-primary" id="customlabelbutton">Add Label</button>
			      </div>
			    </div>
			  </div>
			  </div>
...
<div class="modal fade model1" id="myModalMobile">
			<div class="modal-dialog modal-sm"  >
			    <div class="modal-content" >
			      ...
			      <div class="modal-body">
			      <input type="text"
							class="form-control customfeild" id="customMobilelabelfeild" name="customlabelfeild"
							placeholder="Enter Custom label" />
			      </div>
			      <div class="modal-footer">
			        <button type="button" class="btn btn-default"  id="myModalMobileClose">Close</button>
			        <button type="button" class="btn btn-primary" id="customMobilelabelbutton">Add Label</button>
			      </div>
			    </div>
			  </div>
			  </div>
		...
		<form id="reg-form" class="form-signin">
			...
			<label>${message}</label> <label>Name</label> <input type="text"
				...
				<div class="select-div">
					<select class="form-control form-select email-type email-type-reg" id="ContactEmailType1" name="ContactEmailType" required="true">
				...
				<input type="email" class="phonefield email-address email-address-reg" id="ContactEmail1"
			...
			<div class="input-row" id="mpbileno-container1">
				...
				<div class="select-div">
					<select class="form-control form-select mobile-type mobile-type-reg" id="MobileNoType1" >
						<option>home</option>
						<option>work</option>
						<option>other</option>
					</select>
				...
				<input type="number"  required="true" class="phonefield mobile-num mobile-num-reg" id="ContactMobileNo1"
