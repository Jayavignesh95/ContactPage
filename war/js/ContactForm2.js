...
$("#customMobilelabelbutton").click(function()
		{
			var customlabelvalue = document.getElementById("customMobilelabelfeild").value;
			 $('.all-mobile_div').find('select').append('<option  >'+customlabelvalue+'</option>');
			 $("#"+select_source).val(customlabelvalue);
	...
	var emailFlag = true;
		var mobileFlag = true;
		event.preventDefault();
		var emailTypes = document.getElementsByClassName("email-type-reg");
		var emailAddress = document.getElementsByClassName("email-address-reg");
		var mobileType = document.getElementsByClassName("mobile-type-reg");
		var mobileNum = document.getElementsByClassName("mobile-num-reg");
